...
class _CheckoutState extends State<Checkout> {
  ...
  List<Map> gateways = [
    ...
    },
    {
      'name': 'Nagad',
      'logo':
          'https://freepnglogo.com/images/all_img/1725618898nagad-vertical-logo-png.png',
    },
    {
      'name': 'PayPal',
      'logo':
          'https://1000logos.net/wp-content/uploads/2017/05/Color-Paypal-Logo-500x404.jpg',
    },
    {
      'name': 'Stripe',
      'logo':
          'https://media.designrush.com/inspiration_images/656400/conversions/1-desktop.jpg',
    },
    {
      'name': 'Payoneer',
        ...
        child: Column(
          children: [
            ...
            InkWell(
              ...
              //     Get.snackbar(
              //       'Oops!',
              //       'Please select bKash as your payment method.',
